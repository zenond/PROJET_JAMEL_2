...
$(document).ready(function()
  {
    ...
    $('.Lancer').on('click' , function(){
      // console.log("lwakhda wa9il jai rien compris");
      // d3.json("data1.json", function(error, data) {
      //   console.log("1 fel first graph");
      //   if (error) 
      //     {
      //       throw error;
      //       console.log("kayna error");
      //     }
      //   // trigger render
      //   else
      //  {
      ...
      // trigger render
       ...
       { 
          console.log("ba nersoum el 4 bel 4");
